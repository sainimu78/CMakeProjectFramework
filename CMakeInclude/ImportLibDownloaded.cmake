		...
		if(WIN32)
			if(v_ListDeployingBinFilePathNoExtFindPackageBasedDebug)
				foreach(It IN LISTS v_ListDeployingBinFilePathNoExtFindPackageBasedDebug)
					...
					if(c_ProjectPipelineSetup OR NOT EXISTS "${DstFilePath0}")
					...
					if(c_ProjectPipelineSetup OR NOT EXISTS "${DstFilePath1}")
	...
	if(c_ProjectRequiredBinInstalling)
		if(WIN32)
			if(v_LibPlatformArchDirPath)
				...
				if(c_ProjectPipelineSetup OR NOT EXISTS "${FilePathDebug}")
				...
				if(c_ProjectPipelineSetup OR NOT EXISTS "${FilePathRelease}")
