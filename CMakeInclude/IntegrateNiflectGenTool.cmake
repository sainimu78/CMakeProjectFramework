...
#set(GenToolBinDirPathDebug ${GenToolRootPath}/build/${c_HostPlatform}/${c_HostArch}/Debug/bin)
#set(GenToolBinDirPathRelease ${GenToolRootPath}/build/${c_HostPlatform}/${c_HostArch}/Release/bin)
...
if (v_MacroTagHeaderFilePath)
	...
	list(APPEND ListOptMacroTagHeaderFilePath "-m" "${NiflectIncludeDirPath}/Niflect/Component/DefaultMacroTag.h")
endif()
...
if(v_ListAccessorSettingHeaderFilePath)
	...
	list(APPEND ListAccessorSettingHeaderFilePath ${NiflectIncludeDirPath}/Niflect/Component/RwTree/Accessor/StandardRwAccessorSetting.h)
endif()
