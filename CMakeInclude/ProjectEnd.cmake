...
set(c_HostPlatform )
if(CMAKE_HOST_WIN32)
	set(c_HostPlatform Windows)
	set(c_HostWindows ON)
elseif(CMAKE_HOST_UNIX AND NOT CMAKE_HOST_APPLE)
	set(c_HostPlatform Linux)
	set(c_HostLinux ON)
elseif(CMAKE_HOST_APPLE)
	set(c_HostPlatform Apple)
	set(c_HostApple ON)
else()
	message(FATAL_ERROR "Host Is Unkonwn")
endif()
...
elseif(APPLE)
	...
	message(FATAL_ERROR "Target Is Unkonwn")
endif()

#if("${c_ProjectPlatform}" STREQUAL "${c_HostPlatform}")
#    message(STATUS "宿主平台和目标平台相同: ${c_ProjectPlatform}")
#    set(c_IsCrossCompiling FALSE)
#else()
#    message(STATUS "交叉编译: 宿主机=${c_HostPlatform}, 目标机=${c_ProjectPlatform}")
#    set(c_IsCrossCompiling TRUE)
#endif()
...
if(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "x86_64|AMD64")
    set(c_HostArch x64)
elseif(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "i386|i686")
    set(c_HostArch x86)
else()
	message(FATAL_ERROR "Unkonw arch")
endif()
...
set(c_ProjectInstalledPlatformArchDirPath ${c_ProjectInstallingDirPath}/${InstalledPlatformArchDirPath})
